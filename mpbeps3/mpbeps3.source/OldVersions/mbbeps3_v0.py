...
if (in3.movion > 0):
   ...
   npi = npxyzi + npxyzbi
# nx/ny/nz = number of grid points in x/y/2 direction
...
# updates exyz, bxyz
   fb3.bread_restart3(exyz,bxyz,tinit,kstrt,iur0,ierr)
   if (ierr[0] != 0):
      mpplib3.ppexit(); exit(1)
   if ((ntime+ntime0[0])> 0):
      dth = 0.5*in3.dt
...
# write out basic restart file for electromagnetic code
         fb3.bwrite_brestart3(exyz,bxyz,tdiag,kstrt,iur)
         dtimer(dtime,itime,1)
