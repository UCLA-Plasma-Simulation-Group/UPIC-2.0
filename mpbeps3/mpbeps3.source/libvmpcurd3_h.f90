!-----------------------------------------------------------------------
! Interface file for libvmpcurd3.f
      module libvmpcurd3_h
      implicit none
!
      interface
         subroutine VPPGJPPOST32L(ppart,cu,kpic,noff,qm,dt,nppmx,idimp, &
...
!
      interface
         subroutine VPPGJPPOSTF32L(ppart,cu,kpic,ncl,ihole,noff,nyzp,qm,&
...
!
      interface
         subroutine VPPGRJPPOST32L(ppart,cu,kpic,noff,qm,dt,ci,nppmx,   &
...
!
      interface
         subroutine VPPGRJPPOSTF32L(ppart,cu,kpic,ncl,ihole,noff,nyzp,qm&
...
!
      interface
         subroutine VPPGMJPPOST32L(ppart,amu,kpic,noff,qm,nppmx,idimp,mx&
...
!
      interface
         subroutine VPPGRMJPPOST32L(ppart,amu,kpic,noff,qm,ci,nppmx,    &
     &idimp,mx,my,mz,nxv,nypmx,nzpmx,mx1,myp1,mxyzp1,idds)
         implicit none
         integer, intent(in) :: nppmx, idimp, mx, my, mz, nxv
         integer, intent(in) :: nypmx, nzpmx, mx1, myp1, mxyzp1, idds
