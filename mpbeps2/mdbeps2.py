...
amut = numpy.empty((in2.ndim,nye,kxp),complex_type,'F')
...
if (kstrt==1):
   print >> iuot
   print >> iuot,"ntime,relativity,ndc=",ntime,",",in2.relativity,",",in2.ndc
   if (in2.treverse==1):
