!-----------------------------------------------------------------------
! Interface file for libvmpfft2.f
      module libvmpfft2_h
      implicit none
!
      interface
...
!
      interface
         subroutine WPPFFT2RVM2(f,g,bs,br,isign,ntpose,mixup,sct,ttp,   &
...
!
      interface
         subroutine WPPFFT2RVM3(f,g,bs,br,isign,ntpose,mixup,sct,ttp,   &
     &indx,indy,kstrt,nvp,nxvh,nyv,kxp,kyp,kypd,nxhyd,nxyhd)
         implicit none
         integer, intent(in) :: isign, ntpose, indx, indy, kstrt, nvp
         integer, intent(in) :: nxvh, nyv, kxp, kyp, kypd, nxhyd, nxyhd
...
!
      interface
         subroutine PPFFT2RVMXX(f,isign,mixup,sct,indx,indy,kstrt,kypi, &
...
!
      interface
         subroutine PPFFT2RVMXY(g,isign,mixup,sct,indx,indy,kstrt,kxpi, &
...
!
      interface
         subroutine PPFFT2RVMNXX(f,ss,isign,mixup,sct,indx,indy,kstrt,  &
