...
# updates exyz, bxyz
   sb2.bread_restart23(exyz,bxyz,iur0)
   if ((ntime+ntime0[0])> 0):
      dth = 0.5*in2.dt
...
# write filename to diagnostic metafile
#     if (sys.version_info.major==3):
#        in2.farname = farname.ljust(in2.farname.dtype.itemsize)
#     else:
#        in2.farname[:] = farname
# open file
#     if (in2.narrec==0):
...
if (kstrt==1):
   print ("program mpbbeps2",file=iuot)
...
#                       tfield,nx,ny,kstrt)
# analytic solver
      mfield2.mpamaxwel2(exyz,bxyz,cut,ffc,affp,in2.ci,in2.dt,wf,wb,
                         tfield,nx,ny,kstrt)
...
# write out basic restart file for electromagnetic code
         sb2.bwrite_restart23(exyz,bxyz,iur)
